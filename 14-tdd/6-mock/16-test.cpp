...
struct MockVector
{
  ...
  void push_back(const T& t)	
  {
    ...
    mock().actualCall("push_back").onObject(this);	  
    vec_.push_back(t);	  
  }
  void insert( typename std::vector<T>::iterator it, const T& t)
  {
    mock().actualCall("insert").onObject(this);	  
    vec_.insert(it,t);	  
  }
  void erase( typename std::vector<T>::iterator it)
  {
    mock().actualCall("erase").onObject(this);	  
    vec_.erase(it);	  
  }
...
TEST(Mocking, FirstAlloc)
{
  Deq<int,MockVector<int>> di;

  mock().expectOneCall("push_back").onObject(&di);
